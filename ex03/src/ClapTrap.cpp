...
/*   Updated: 2025/03/10 11:24:08 by ylenoel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << C_QUARTZ "ClapTrap copy constructor called!" C_RESET << std::endl;
...
{
	std::cout << C_QUARTZ "Copy assignement called!" C_RESET << std::endl;
